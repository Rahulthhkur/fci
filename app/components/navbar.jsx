...
const Navbar = () => {
  ...
  <nav className="flex space-x-8">
    ...
    {/* For hash links (scrolling on the same page), prefix with /# */}
    {/* Alternatively, if '/work' is a separate page, use href="/work" */}
    <Link href="/services" className="hover:text-gray-300 transition-colors">
      Services
    </Link>

    <Link href="/#approach" className="hover:text-gray-300 transition-colors">
      Approach
    </Link>
  ...
  {/* If the button navigates to a page (e.g., /contact), use Link */}
  {/* If it triggers an action (e.g., opens modal), keep it as a <button> */}
  <Link
    href="/contact" // Assuming it links to a contact page
    className="border border-white px-5 py-2 flex items-center space-x-2 hover:bg-white hover:text-black transition-colors"
  >
    <span>Contact</span>
